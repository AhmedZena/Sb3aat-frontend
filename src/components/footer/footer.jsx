...
//             </p>
//             <p className="mb-4">
//               <a className="text-white dark:text-neutral-200">React</a>
//             </p>
//             <p className="mb-4">
//               <a className="text-white dark:text-neutral-200">Vue</a>
//             </p>
//             <p>
//               <a className="text-white dark:text-neutral-200">Laravel</a>
//             </p>
//           </div>
...
//             </p>
//             <p className="mb-4">
//               <a className="text-white dark:text-neutral-200">Settings</a>
//             </p>
//             <p className="mb-4">
//               <a className="text-white dark:text-neutral-200">Orders</a>
//             </p>
//             <p>
//               <a className="text-white dark:text-neutral-200">Help</a>
//             </p>
//           </div>
//           {/* <!-- Contact section --> */}
//           <div>
...
//                 <path
//                   fillRule="evenodd"
//                   d="M7.875 1.5C6.839 1.5 6 2.34 6 3.375v2.99c-.426.053-.851.11-1.274.174-1.454.218-2.476 1.483-2.476 2.917v6.294a3 3 0 003 3h.27l-.155 1.705A1.875 1.875 0 007.232 22.5h9.536a1.875 1.875 0 001.867-2.045l-.155-1.705h.27a3 3 0 003-3V9.456c0-1.434-1.022-2.7-2.476-2.917A48.716 48.716 0 0018 6.366V3.375c0-1.036-.84-1.875-1.875-1.875h-8.25zM16.5 6.205v-2.83A.375.375 0 0016.125 3h-8.25a.375.375 0 00-.375.375v2.83a49.353 49.353 0 019 0zm-.217 8.265c.178.018.317.16.333.337l.526 5.784a.375.375 0 01-.374.409H7.232a.375.375 0 01-.374-.409l.526-5.784c.016-.177.155-.319.333-.337L12 13.75l4.283 1.725zM8.625 7.5c0-.204.171-.375.375-.375h6.75c.204 0 .375.171.375.375v2.375H8.25V7.5zm9.375 8.25c-.368 0-.625.281-.625.625l.155 1.705h-8.26l.155-1.705c0-.344-.257-.625-.625-.625H6c-.966 0-1.75.784-1.75 1.75v6.294a1.125 1.125 0 001.125 1.125h11.25a1.125 1.125 0 001.125-1.125V17.5c0-.966-.784-1.75-1.75-1.75h-.25z"
//                   clipRule="evenodd"
//                 />
//               </svg>
...
//         </div>
//          {/* <!--Copyright section--> */}
//  <div className="bg-[#1E293B] text-white text-center font-semibold dark:bg-neutral-600 dark:text-neutral-200 lg:text-left mt-3 mb-2 ">
