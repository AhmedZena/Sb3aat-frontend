...
export default function Cart() {
  ...
  return (
    <div className="container px-4 mx-auto mt-12 mb-4">
      <div className="px-4 py-6 bg-gray-100 rounded-md shadow-lg">
            ...
            <tbody>
              {orders.map((cart, index) => (
                <tr key={index} className="border-b border-gray-300">
                  <td className="px-4 py-2">
                    {cart.productType === "service" ? (
                      <>
                        ...
                        <img
                          className="w-20 h-16 mt-2 ml-2 object-cover"
                  ...
                  <td className="px-4 py-2 font-semibold">{cart.price}$</td>
                  <td className="px-4 py-2">
                    <select
                      value={cart.quantity}
...
//             to="/cart"
//             onClick={handleDeleteAllItems}
//             className="px-2 py-2 ml-10 text-white transition duration-300 bg-red-500 rounded-md hover:bg-red-600 "
//           >
//             Delete all Items
//           </Link>
//          <span className="font-semibold" >{initialTotalPrices}$</span>
//         </div>
//       </div>
//     </div>
//   );
